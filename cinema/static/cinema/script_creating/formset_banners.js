$('#add_more').click(function() {
	var form_idx = $('#id_main_formset-TOTAL_FORMS').val();
	$('#form_set').append($('#empty_form').html().replace(/__prefix__/g, form_idx));
	$('#id_main_formset-TOTAL_FORMS').val(parseInt(form_idx) + 1);
});

$('#add_more_news').click(function() {
	var form_idx = $('#id_news_formset-TOTAL_FORMS').val();
	$('#news_form_set').append($('#news_empty_form').html().replace(/__prefix__/g, form_idx));
	$('#id_news_formset-TOTAL_FORMS').val(parseInt(form_idx) + 1);
});
